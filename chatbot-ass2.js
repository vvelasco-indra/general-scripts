  ...
  (function () {
    ...
    const sendMessage = () => {
      ...
      if (message) {
        ...
        const source = new EventSource(`https://assistant-ai-mu.vercel.app/v1/ask/assistant?question=${encodeURIComponent(message)}&assistant_id=6aaadf7d-6490-4d75-942a-bbd6851bca40`);
